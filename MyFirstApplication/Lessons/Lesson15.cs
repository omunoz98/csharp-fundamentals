...
public enum Day { Sat, Sun, Mon, Tue, Wed, Thu, Friday};
...
internal class Lesson15
{
    ...
    public string FavoriteIceCream(IceCreamFlavors flavors)
    {
        string message = flavors switch
        {
            ...
            IceCreamFlavors.Chocolate => $"My favorite is {IceCreamFlavors.Strawberry}",
            IceCreamFlavors.Strawberry => $"My favorite is {IceCreamFlavors.Chocolate}",
    ...
    /*
     Tuples are a group of types using parathesis separating with a coma.
     */
